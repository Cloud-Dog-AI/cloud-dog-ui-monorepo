...
// PS-76 v2 Job Control WebUI for code-runner-server.
  ...
  return (
    <div className="space-y-6">
      ...
      <DataTable
        ...
        tableId="code-runner-jobs-ps76-v2"
        ariaLabel="Code Runner jobs"
      />
          ...
          <div className="space-y-4">
            ...
            <Tabs value={detailTab} onValueChange={setDetailTab}>
              ...
              <TabsContent value="thinking">
                <p className="text-sm text-muted-foreground">No thinking trace recorded for code-runner discovery jobs.</p>
              </TabsContent>

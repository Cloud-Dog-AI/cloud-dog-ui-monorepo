...
// @cloud-dog/app-sql-agent — PS-72 v2 shared console parts (W28A-774).
// API-key field (§2), result widget + meta panel (§5), lifecycle/health badges (§7).

import * as React from "react";
import { Input } from "@cloud-dog/ui";
import { JsonBlock } from "../../lib/sqlAgentApi";
import {
  formatDuration,
  lifecycleTone,
 ...
 * (session/cookie for sql-agent). The admin override is masked (type=password)
 * and the value is only sent on the API call, never logged client-side (§2.4).
 */
 ...
 * are NEVER N/A (client-generated fallback is flagged).
 */

...
Test utilities -- Playwright helpers, axe accessibility checks.
...
npm install
npm run build --workspace=packages/testing
```
...
|-----------|------|---------|
| @playwright/test | production | End-to-end browser testing framework |
| axe-core | production | Accessibility auditing engine |
...
## Tests
```bash
npm run test --workspace=packages/testing
```
